...
Write-Host "Installing AIDE skills for Qwen Code..." -ForegroundColor Cyan
...
if ($SkillsPath -eq "") {
    $SkillsPath = Join-Path $RepoRoot ".qwen\skills"
}

Write-Host "Repo root: $RepoRoot" -ForegroundColor Gray
Write-Host "Target Qwen skills dir: $SkillsPath" -ForegroundColor Gray
...
Write-Host ""
Write-Host "Installed skills (repo-local .qwen/skills):" -ForegroundColor Cyan
foreach ($skill in $skills) {
...
Write-Host "  2. Type '/' in Qwen chat to see available commands"
Write-Host ""
