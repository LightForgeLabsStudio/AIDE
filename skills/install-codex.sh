...
echo -e "\033[0;36mInstalling AIDE skills for Codex...\033[0m"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: install-codex.sh [--symlink] [--repo-root PATH] [--skills-path PATH]"
            exit 1
            ;;
    esac
done
...
echo -e "\033[0;37mTarget Codex skills dir: $SKILLS_PATH\033[0m"
